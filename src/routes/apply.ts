...
router.post('/', publicLimiter, async (req: Request, res: Response) => {
  try {
    const {
      fullName, fatherName, degree, institution, graduationDate,
      email, phoneCode, phone,
      role, skills, projects, portfolioLinks,
      hasExperience, experienceDetail,
      problemSolving, motivation,
      availability, startDate,
      githubUrl, linkedinUrl,
      workPreference, proficiency, extraInfo,
    } = req.body;
