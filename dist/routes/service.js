...
router.post('/', authenticate, authorize('ADMIN'), validate(serviceSchema), async (req, res, next) => {
    try {
...
router.put('/:id', authenticate, authorize('ADMIN'), validate(serviceSchema), async (req, res, next) => {
    try {
